      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            widget.place["isActive"] == true ? ratingAndStarTrue() : ratingAndStarFalse(),
            SizedBox(height: size.height * 0.02),
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  placePropertyList(
                    ...
                    "This is a rare find",
                    "${widget.place['vendor']}'s yacht is usually fully booked.",
                  ),
                  const Divider(),
                  placePropertyList(
                    size,
                    widget.place['vendorProfile'],
                    "Book with ${widget.place['vendor']}",
                    "Superhost . ${widget.place['yearOfHostin']} years hosting",
                  ),
                  const Divider(),
                  placePropertyList(size, "https://cdn-icons-png.flaticon.com/512/6192/6192020.png", "Room in a rental unit", "Your own room in a home, pluse access\nto shared spaces."),
                  placePropertyList(size, "https://cdn0.iconfinder.com/data/icons/co-working/512/coworking-sharing-17-512.png", "Shared common spaces", "You'll share parts of the home with the host,"),
                  placePropertyList(size, "https://img.pikbest.com/element_our/20230223/bg/102f90fb4dec6.png!w700wp", "Shared bathroom", "Your'll share the bathroom with others."),
                  const Divider(),
                  SizedBox(height: size.height * 0.02),
                  const Text(
                    "About this place",
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: MyIconButton(
                    ...
                    iconColor: provider.isExist(widget.place) ? Colors.red : Colors.black,
                  ),
                )
              ],
            ),
